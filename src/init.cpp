...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Bluecoiner/bluecoin-core>";
    const std::string URL_WEBSITE = "<https://bluecoin-core.org>";
