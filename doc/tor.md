...
It is possible to run Bluecoin as a Tor hidden service, and connect to such services.
...
The first step is running Bluecoin behind a Tor proxy. This will already make all
