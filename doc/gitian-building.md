...
*Setup instructions for a Gitian build of Bluecoin Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the Bluecoin
...
- [Building Bluecoin Core](#building-litecoin-core)
...
To build Bluecoin Core (for Linux, OS X and Windows) just follow the steps under 'perform
...
Output from `gbuild` will look something like
    ...
    From https://github.com/Bluecoiner/bluecoin-core
...
cd /some/root/path/
git clone https://github.com/Bluecoiner/litecoin-detached-sigs.git
...
[gitian.sigs.ltc](https://github.com/Bluecoiner/gitian.sigs.ltc/) repository, or if that's not possible create a pull
